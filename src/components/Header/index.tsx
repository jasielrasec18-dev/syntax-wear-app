  ...
  return (
    <div className="relative">
      <header className="fixed bg-amber-700 top-0 left-0 right-0 z-10 mx-10">
        <div className="bg-white max-w-[1320px] mx-auto flex justify-between items-center py-5 px-7 rounded-2x1 mt-5">
          <img src={Logo} alt="Logo SyntaxWear" className="md:w-36"/>
